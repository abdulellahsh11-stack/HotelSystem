...
<footer><div style="margin-bottom:8px"><a href="#hero">الرئيسية</a><a href="#features">الخدمات</a><a href="#login">تواصل</a></div>© 2026 {sn} — جميع الحقوق محفوظة &nbsp;|&nbsp; يعمل مع الفنادق والشقق المخدومة &nbsp;|&nbsp; 🇸🇦 تمت برمجته بأيدي سعودية 100%</footer>

...
.nav-logo span{{color:var(--white);font-weight:400;font-size:14px;margin-right:6px;}}
...
<nav><div class="nav-inner">
  <div class="nav-logo">{em} {sn} <span>برنامج إدارة الفنادق</span></div>
  <div class="nav-links">
...
<section class="hero" id="hero">
  <div class="hero-inner">
    <div class="hero-text fade">
      <h1>استمتع بإدارة مالية متكاملة لفندقك مع برنامج<em>{sn} المتطور!</em></h1>

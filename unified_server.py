...
class AnalyticsEngine:
    ...
    def session_open(self, token, cid, hotel_name="", name=""):
        with self._lock:
            ...
            cs = self.client_stats.setdefault(str(cid), {"days_active":set(),"total_actions":0,"last_page":"—","errors":0,"first_seen":_today(),"last_login":"","hotel_name":"","name":""})
    ...
    def snapshot(self):
        with self._lock:
            ...
            return {
                ...
                "client_stats":     {k:{"days_active":len(v["days_active"]),"total_actions":v["total_actions"],"last_page":v["last_page"],"errors":v["errors"],"first_seen":v.get("first_seen",""),"last_login":v.get("last_login",""),"hotel_name":v.get("hotel_name",""),"name":v.get("name","")} for k,v in self.client_stats.items()},

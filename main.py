  ...
  <div class="content">
    ...
    <div class="pg" id="pg-kpi">
      ...
      <div class="card ca">
        ...
        <div class="g3">
          <div class="fg"><label>المدينة</label><select id="mkt-city"><option value="riyadh">الرياض</option><option value="jeddah">جدة</option><option value="makkah">مكة</option><option value="madinah">المدينة</option><option value="dammam">الدمام</option><option value="abha">أبها</option><option value="taif">الطائف</option></select></div>
      ...
      <div class="card cb">
        ...
        <div class="g2">
          ...
          <div class="fg"><label>المدينة <span class="tt-ic" data-tt="تحدد بيانات السوق المقارنة — أسعار المنافسين في نفس المدينة">ℹ️</span></label>
            <select id="cfg-city"><option value="riyadh">الرياض</option><option value="jeddah">جدة</option><option value="makkah">مكة</option><option value="madinah">المدينة</option><option value="dammam">الدمام</option><option value="abha">أبها</option><option value="taif">الطائف</option></select>
          </div>
        </div>

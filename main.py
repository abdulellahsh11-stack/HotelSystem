...
def _get_owner_ai_key():
    """يجلب مفتاح Claude API للمالك من ملف admin_store.json المشترك"""
    try:
        import os, json as _json
        base = os.path.dirname(os.path.abspath(__file__))
        data_file = os.path.join(base, "..", "HotelAdmin", "data", "admin_store.json")
...
async function clientLogout(){
  ...
  // مسح الكوكي من الجانب العميل أيضاً كضمان
  document.cookie='client_token=; Path=/; Max-Age=0; expires=Thu, 01 Jan 1970 00:00:00 GMT';
  location.href='/';
}

...
class AdminHandler(BaseHTTPRequestHandler):
    ...
    def _p_settings_save(self, b):
        ...
        for k in ["owner_name","owner_email","owner_phone","owner_whatsapp","owner_account_name","contact_message","system_name","bank_iban","bank_name","owner_iban","owner_bank","trial_days","prices","plans","ai_market_competitors"]:
            if k in b: s[k] = b[k]
